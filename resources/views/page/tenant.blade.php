                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="" data-bs-toggle="modal"
                                                        class="btn btn-outline-danger ml-1" data-bs-target="#modalDelete">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" placeholder="nama" name="name" value="" class="form-control">
                        </div>
                        <label>Tenant: </label>
                        <div class="form-group">
                            <input type="text" placeholder="Tenant" name="tenant" value="" class="form-control">
                        </div>
                        <label>Email: </label>
                        <div class="form-group">
    ...
    @foreach ($outlet as $item)
        <div class="modal fade text-left" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Edit Tenant </h4>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <i data-feather="x"></i>
                        </button>
                    </div>
                    <form action="" method="post" id="formEdit">
                        ...
                        <div class="modal-body">
                            <label>Nama: </label>
                            <div class="form-group">
                                <input type="text" placeholder="nama" name="name" value=""
                                    class="form-control">
                            </div>
                            <label>Tenant: </label>
                            <div class="form-group">
                                <input type="text" placeholder="Tenant" name="tenant" value=""
                                    class="form-control">
                            </div>
                            <label>Email: </label>
                            <div class="form-group">
